            ...
            <TableRow>
              <TableHead style={{ width: columnWidths }}>
                <Text className="text-md text-center font-bold">
                  {t('return-detail.tracking-number')}
                </Text>
              </TableHead>
              <TableHead style={{ width: columnWidths }}>
                <Text className="text-md text-center font-bold">
                  {t('return-detail.state')}
                </Text>
              </TableHead>
            </TableRow>
          </TableHeader>
            ...
            <FlashList
              ...
              renderItem={({ item: { trackingNumber }, index }) => {
                const alreadyScanned =
                  scannedTrackingNumbers.has(trackingNumber);
                return (
                  <TableRow
                    key={trackingNumber}
                    className={cn(
                  ...
                  >
                    ...
                    <TableCell style={{ width: columnWidths }}>
                      <Text className="text-center">
                        {alreadyScanned
                          ? t('return-detail.scanned')
                          : t('return-detail.not-scanned')}
                      </Text>
                    </TableCell>
                  </TableRow>
                );
